...
export const FOUNDER_STORY = {
  meta: {
    title: "Zizo (Ahmad Zeidan). Founder of Sofratak",
    description:
  ...
  otherSide: {
    title: "Built From the Other Side of the Table",
    intro: [
    ...
    // rendered as a staggered fade-in list (implementation note in the spec)
    fragments: [
      "One company handled ordering.",
      "Another handled delivery.",
      "Another handled customer data.",
      "Another handled email.",
      "Another handled SMS.",
  ...
  community: {
    title: "Deeply Connected to the Arab Hospitality Community",
    paragraphs: [
  ...
  slogan: {
    title: "Take Control. Own Your Growth.",
    paragraphs: [
  ...
  builtFor: {
    title: "Built With Arab Restaurants in Mind. Built for Restaurants Everywhere.",
    paragraphs: [
  ...
  infrastructure: {
    title: "From Marketing Restaurants to Building Their Growth Infrastructure",
    paragraphs: [
  ...
  note: {
    ...
    signature: "Zizo (Ahmad Zeidan)",
    signatureRole: "Founder, Sofratak",
  },

  // ── Reuse map (docs/founder-story.md §2) ──────────────────────────────
  reuse: {
    homeBlurbTitle: "Built by someone who's sat on the other side of the table.",
    homeBlurb:
      "Ahmad Zeidan (Zizo) spent years growing Arab restaurants through Offbeat Creative before building Sofratak. This isn't a generic SaaS guess at what restaurants need.",
    homeLink: "Read our story →",
    footerMission:
      "Built by Offbeat Creative. Working with Arab restaurants across the US. Take Control. Own Your Growth.",
    badge: "Built by Offbeat Creative",
    demoReassurance:
      "You'll be talking to Zizo (Ahmad Zeidan) directly, not a call center.",
    cityTrust:
      "Sofratak comes from Offbeat Creative, which has worked with Arab and Mediterranean restaurants across the country.",
  },
} as const;
