...
export const CITIES: City[] = [
  {
    ...
    knownFor: [
      { en: "Busch Blvd halal corridor", ar: "شارع بوش بمطاعمه الحلال" },
      { en: "Yemeni coffee houses", ar: "مقاهي يمنية" },
      { en: "USF student crowd", ar: "طلاب جامعة USF" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Central Avenue food row", ar: "شارع سنترال أفينيو" },
      { en: "Lebanese bakeries", ar: "مخابز لبنانية" },
      { en: "Tourist-season takeout", ar: "طلبات موسم السياحة" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "West Colonial corridor", ar: "محور ويست كولونيال" },
      { en: "Palestinian bakeries", ar: "مخابز فلسطينية" },
      { en: "Turkish grills", ar: "مشاوي تركية" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Baymeadows halal spots", ar: "مطاعم بايميدوز الحلال" },
      { en: "Mandi houses", ar: "بيوت المندي" },
      { en: "Spread-out delivery city", ar: "مدينة توصيل مترامية" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Coral Way Lebanese grills", ar: "مشاوي كورال واي اللبنانية" },
      { en: "Late-night halal", ar: "حلال حتى وقت متأخر" },
      { en: "High-cost delivery market", ar: "سوق توصيل مكلف" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "High-volume takeout", ar: "طلبات خارجية بكثافة" },
      { en: "Beach + local mix", ar: "خليط الشاطئ والسكان" },
      { en: "Mediterranean grills", ar: "مشاوي متوسطية" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Hollywood Blvd & 441", ar: "هوليوود بوليفارد وطريق 441" },
      { en: "Lebanese & Syrian kitchens", ar: "مطابخ لبنانية وسورية" },
      { en: "Weekend manakish rush", ar: "زحمة مناقيش نهاية الأسبوع" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Seasonal swings", ar: "مواسم متقلبة" },
      { en: "Mediterranean & halal kitchens", ar: "مطابخ متوسطية وحلال" },
      { en: "Flat fee beats % in season", ar: "الرسوم الثابتة تكسب في الموسم" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Warren Avenue", ar: "شارع وارن" },
      { en: "Yemeni · Lebanese · Iraqi · Palestinian", ar: "يمني · لبناني · عراقي · فلسطيني" },
      { en: "Ramadan lines out the door", ar: "طوابير رمضان" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Ford Road bakeries", ar: "مخابز فورد رود" },
      { en: "Telegraph grill houses", ar: "مشاوي تلغراف" },
      { en: "Pickup & delivery heavy", ar: "استلام وتوصيل بكثافة" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "West side halal counters", ar: "عدادات الحلال في الجانب الغربي" },
      { en: "Yemeni coffee downtown", ar: "قهوة يمنية وسط المدينة" },
      { en: "Weekly regulars", ar: "زبائن أسبوعيون دائمون" },
    ],
    metaDescription: {
  ...
  },
  {
    ...
    knownFor: [
      { en: "Joseph Campau", ar: "جوزيف كامباو" },
      { en: "Yemeni & Bangladeshi food", ar: "أكل يمني وبنغلاديشي" },
      { en: "Two square miles of flavor", ar: "ميلان مربعان من النكهة" },
    ],
    metaDescription: {
